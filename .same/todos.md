...
## Completed
- [x] Add filtered gallery to /our-work page
- [x] Add upload interface for gallery images
- [x] Create API route for image uploads
- [x] Store uploaded images in the project
