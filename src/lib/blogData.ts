...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310214787-55cey7bejpy.jpg',
    content: {
  ...
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310214973-taesj8u134p.jpg',
    content: {
      ...
      sections: [
        {
          ...
          content: 'Wishing you the "Good";\n\nunderstanding when life seems "bad" and\n\nready to laugh with you through the "Ugly"\n\n<div style="margin-top: 20px; padding: 20px; background-color: #f5f5f5; border-radius: 8px;"><p style="font-style: italic;">When the going is Good, it\'s easy to be thankful. When it\'s bad, we search for meaning; the lesson, a silver lining. Sometimes this works. When it\'s just plain Ugly, sometimes we have to turn around to see the blessings we have passed by unaware in our unwavering focus toward... whatever. Maybe the \'ugly\' gives us a chance to change course & depart from what doesn\'t work in our lives. This departure is truly something we can be thankful for.</p></div>'
        }
      ]
    }
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310215485-x1ll9sgvldl.jpg',
    content: {
  ...
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310215664-1yycucn0gqx.jpg',
    content: {
  ...
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310215830-jp73zg9wl9p.jpg',
    content: {
  ...
  },
  {
    ...
    image: '/gallery/awning-cleaning-1765310216151-di2tluzoada.jpg',
    content: {
