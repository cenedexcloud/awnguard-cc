        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            {openAccordion === 'childhood' && (
              <div className="px-4 pb-4 text-sm text-gray-700 leading-relaxed space-y-3">
                <div className="w-16 h-16 mb-4 bg-[#1b4f75] rounded-full flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            {openAccordion === 'movement' && (
              <div className="px-4 pb-4 text-sm text-gray-700 leading-relaxed space-y-3">
                <div className="w-16 h-16 mb-4 bg-[#ab772c] rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            {openAccordion === 'vision' && (
              <div className="px-4 pb-4 text-sm text-gray-700 leading-relaxed space-y-3">
                <div className="w-16 h-16 mb-4 bg-[#2c5f7f] rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
