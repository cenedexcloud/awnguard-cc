...
export default function Testimonials() {
  const testimonials = [
    {
      id: 1,
      quote:
        "I'm glad you've been our awning cleaners for the past 10 years. We love your team and we are happy to support a local small business. Thank you!",
      author: "Allie Dixon",
    ...
    },
    {
      id: 3,
      quote:
        "AwnGuard has been cleaning and maintaining my awning for over a decade. When I look down the street – it is obvious who has invested in proper maintenance. Stores with neglected awnings look faded and dirty while mine looks awesome! My awning is less faded than the paint on my building. If I ever have another awning, I will definitely call you.",
      author: "Brook Daniel",
      role: "Owner",
    ...
    },
    {
      id: 4,
      quote:
        "You've always been great to work with. You've done a great job since day one – and we appreciate how you remind us when it's time to clean.",
      author: "Ross Melodia",
      role: "Property Manager",
      company: null,
    },
    {
      id: 5,
      quote:
        "Your team always does a great job. We are thankful for our 20-year relationship, and don't ever plan to switch.",
      author: "Phil Ladman",
      role: "Property Manager",
    ...
    },
    {
      id: 6,
      quote:
        "I like the ongoing subscription model where I don't have to think. AwnGuard schedules ahead based on our original agreement and it just gets done. It's a beautiful thing.",
    ...
    },
    {
      id: 8,
      quote:
        "Your service is very good. When one of the braces was loose, you kindly pointed it out to us. Your quality cleaning helps improve the life span of the awnings and we appreciate your added attention. You offer a good service. Thank you!",
    ...
    },
    {
      ...
      role: "Property Manager",
      company:
        "Mira Mesa Shopping Center West & Mira Mesa Shopping Center East",
    },
    {
      id: 11,
    ...
    },
    {
      id: 12,
      quote:
        "Doing business with your company has been trouble-free and we have enjoyed it. Thank you for your services.",
      author: "Barbara S.",
      role: null,
      company: "D&B Auto",
    },
  ...
  // Images from local gallery
  const storeImages = [
    {
      src: "/gallery/awning-cleaning-1765310214178-iw4pfoo7er.jpg",
      alt: "GAP Store",
    },
    {
      src: "/gallery/awning-cleaning-1765310214419-a8yuugv20dq.jpg",
      alt: "Exú Store",
    },
    {
      src: "/gallery/awning-cleaning-1765310214616-hm0bp2ak64h.jpg",
      alt: "Restaurant",
    },
    {
      src: "/gallery/awning-cleaning-1765310214787-55cey7bejpy.jpg",
      alt: "Building Exterior",
    },
    {
      src: "/gallery/awning-cleaning-1765310214973-taesj8u134p.jpg",
      alt: "Commercial Building",
    },
    {
      src: "/gallery/awning-cleaning-1765310215485-x1ll9sgvldl.jpg",
      alt: "Residential Building",
    },
    {
      src: "/gallery/awning-cleaning-1765310215664-1yycucn0gqx.jpg",
      alt: "Restaurant Storefront",
    },
    {
      src: "/gallery/awning-cleaning-1765310215830-jp73zg9wl9p.jpg",
      alt: "Retail Store",
    },
    {
      src: "/gallery/awning-cleaning-1765310216151-di2tluzoada.jpg",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                The AwnGuard team works tirelessly to ensure every customer has
                a five-star experience. After all, we couldn't have a successful
                business without them, and we appreciate each and every one.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[3].author} | {testimonials[3].role}{" "}
                {testimonials[3].company && `| ${testimonials[3].company}`}
              </p>
            </div>
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[4].author} | {testimonials[4].role} |{" "}
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[5].author} | {testimonials[5].role} |{" "}
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[6].author} | {testimonials[6].role} |{" "}
                {testimonials[6].company}
              </p>
            </div>
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[7].author} | {testimonials[7].role}{" "}
                {testimonials[7].company && `| ${testimonials[7].company}`}
              </p>
            </div>
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[8].author} | {testimonials[8].role} |{" "}
                {testimonials[8].company}
              </p>
            </div>
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[9].author} | {testimonials[9].role} |{" "}
                {testimonials[9].company}
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[10].author} | {testimonials[10].role} |{" "}
                {testimonials[10].company}
              </p>
            </div>
            ...
            <div className="bg-[#f6f6f6] p-8 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                - {testimonials[11].author}{" "}
                {testimonials[11].role && `| ${testimonials[11].role}`} |{" "}
                {testimonials[11].company}
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f6f6f6] p-8 rounded-lg mt-6">
            ...
            <p className="text-gray-600 text-sm">
              - {testimonials[12].author} | {testimonials[12].role} |{" "}
              {testimonials[12].company}
            </p>
          </div>
