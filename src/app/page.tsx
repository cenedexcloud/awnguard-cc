    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-20 min-h-screen flex items-center justify-center bg-[#1a1a1a] overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 py-20">
          ...
          <a
            href="/quote"
            className="inline-block bg-[#ab772b] text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-[#01548f] hover:border-[#01548f] transition-colors border-2 border-[#ab772b]"
          >
            Request a Quote
          </a>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 text-center rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <a href="/services/solar-panel-cleaning" className="inline-block border-2 border-[#1b4f75] text-[#1b4f75] px-8 py-3 rounded-full hover:bg-[#1b4f75] hover:text-white transition-colors">
                Learn More
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="/testimonials"
                className="inline-block bg-primary text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-[#00558e] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
