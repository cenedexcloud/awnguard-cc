    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6 uppercase">
          ...
          <Link
            href="/contact"
            className="inline-block bg-primary text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:bg-primary/90 transition-colors"
          >
            Request a Quote
          </Link>
        </div>
