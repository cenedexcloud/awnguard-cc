    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-800 mb-6 uppercase">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="md:w-2/3">
              {/* Awning Recover */}
              <div className="mb-10">
                <h2 className="text-2xl md:text-3xl text-gray-800 mb-3 uppercase tracking-wide">
                  AWNING RECOVER
                </h2>
