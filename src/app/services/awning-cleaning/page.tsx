    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl text-gray-800 mb-6 uppercase tracking-wide">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              {/* Right: Content */}
              <div>
                <h2 className="text-3xl md:text-4xl text-gray-800 mb-3 uppercase">
                  Awning Cleaning
                </h2>
          ...
          <section className="mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              {/* Right: Content */}
              <div>
                <h2 className="text-3xl md:text-4xl text-gray-800 mb-4 uppercase">
