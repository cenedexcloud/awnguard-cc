  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-[300px] px-4">
          <h1 className="text-5xl md:text-6xl text-gray-800 tracking-wide text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-1 items-start">
            ...
            <div className="-mt-8">
              <div>
                ...
                <div className="w-80 h-1 mb-5" style={{ backgroundColor: '#C8A67A' }}></div>
              </div>

              <div className="space-y-2 text-gray-600 leading-relaxed mb-5">
                <p>
