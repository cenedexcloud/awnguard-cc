...
const ExitIntentPopup = forwardRef<ExitIntentPopupRef>((props, ref) => {
  ...
  const shouldShowPopup = () => {
    ...
    return daysSinceLastShown >= 14; // Show once every 14 days
  };

  useEffect(() => {
    // Exit intent detection only - no time-based trigger
    const handleMouseLeave = (e: MouseEvent) => {
      // Detect when mouse leaves viewport at the top (exit intent)
  ...
  }, []); // Empty dependency array since shouldShowPopup is called inside
        ...
        >
          ...
          <div className="bg-[#8ea5b5]/10 border-2 border-[#9a6d43] rounded-lg p-4 md:p-6 mb-4 md:mb-6">
            <div className="text-center">
              ...
              <p className="text-xs md:text-sm text-gray-600 mb-2">
                Schedule now and save up to $1,000
              </p>
              <p className="text-xs md:text-sm text-gray-600 mb-2">
                with quarterly or monthly service contract
              </p>
          ...
          <div className="grid grid-cols-4 gap-2 md:gap-3 pt-4 md:pt-6 border-t border-gray-200">
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-[9px] md:text-xs text-gray-700 font-semibold text-center leading-tight">Cleaned 1 Million Awnings</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="bg-[#9a6d43] rounded-full p-1.5 md:p-2">
                <Check className="w-4 h-4 md:w-5 md:h-5 text-white" />
